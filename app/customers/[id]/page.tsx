        ...
        <div className="info-card">
          ...
          <div className="info-grid">
            ...
            <div className="info-item">
              ...
              {isEditingInfo ? (
                <input type="date" max="9999-12-31" className="edit-input" name="계약만료일" value={editForm.계약만료일} onChange={handleFormChange} />
              ) : (
            ...
            <div className="info-item">
              ...
              {isEditingInfo ? (
                <input type="date" max="9999-12-31" className="edit-input" name="작업완료일" value={editForm.작업완료일} onChange={handleFormChange} />
              ) : (
